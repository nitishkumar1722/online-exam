...
<div class="top-header">
    ...
    <h2 class="portal-title">Teacher Dashboard</h2>
</div>

<div id="sidebar" class="sidebar">
    <a href="javascript:void(0)" class="closebtn" onclick="toggleSidebar()">&times;</a>
    <div class="sidebar-links">
        <button onclick="showPage('createExam')">📝 Create Exam</button>
        <button onclick="showPage('addStudent')">👨‍🎓 Add Student</button>
        <button onclick="showPage('viewData')">📊 View Records</button>
        <hr>
...
<div id="main-content" class="main-container">
    <div id="welcomeNote">
        ...
        <p>Menu bar se option select karein.</p>
    </div>

    <div id="createExam" class="page-section" style="display:none;">
        <h3>Create New Exam</h3>
        <input type="text" id="examTitle" placeholder="Exam Title">
        <input type="number" id="examDuration" placeholder="Duration (min)">
        <button class="action-btn" onclick="createExam()">Create Now</button>
    </div>

    <div id="addStudent" class="page-section" style="display:none;">
        <h3>Register New Student</h3>
        <input type="text" id="studentName" placeholder="Full Name">
        <input type="text" id="studentReg" placeholder="Registration Number">
        <button class="action-btn" onclick="addStudent()">Add to List</button>
    </div>
</div>
